            ...
            <div class="bg-white hover:bg-white p-5 mb-10 rounded-md shadow-md">
                ...
                <div class="flex justify-between py-3">
                    <div class="w-4/12 mr-5">
                        <label class="block text-gray-500 text-sm uppercase" for="img_path">image file</label>
                        <input type="file" name="img_path" id="img_path"
                            class="w-full h-80 text-xs px-3 py-2 border border-gray-300 rounded-md" value="{{ old('img_path') }}">
                        @error('img_path')
                            <p class="text-red-500 text-sm">{{ $message }}</p>
                        @enderror
                    </div>
